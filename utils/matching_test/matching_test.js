...
function individualDistance(answer_formats, subject, weights, set) {
    ...
    console.log("Max weight   : ", itemWeightMax);
    console.log("Max distance : ", distanceMax);
...
function perform() {
    ...
    console.log('\n');
    const score = performMatch(matchRequest /*a user response*/ , segmentData /* 2 politician responses*/ );
